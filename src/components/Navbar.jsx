...
//         {/* Mobile logo header */}
//         <div style={{ padding: "10px 16px", borderBottom: "1px solid #f0f4f9", display: "flex", alignItems: "center" }}>
//           <img
//             src="/New-logo-768x210.png"
//             alt="Vashishth IAS Academy"
...
//           <button onClick={onContact} style={{ flex: 1, padding: 9, fontSize: 11, fontWeight: 700, background: C.navy, color: "#fff", borderRadius: 4, border: "none", cursor: "pointer", textTransform: "uppercase", letterSpacing: ".05em" }}>
//             Contact Us
//           </button>
//           <button
//             onClick={() => { window.open("/vashishth-brochure.pdf", "_blank"); setMenuOpen(false); }}
